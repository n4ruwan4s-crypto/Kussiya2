...
// 4) Google Analytics (Firebase Analytics) — optional.
// Enable Analytics for this Firebase project in the console, then paste the
// Measurement ID (looks like "G-XXXXXXXXXX") here. Leave as-is to skip analytics.
